...
const addReg = () => {  
    ...
    let regTemplate = document.querySelector('.regTemplate')

    //compile the template
    let compileRegTemplate = Handlebars.compile(regTemplate)
    ...
    if(inputReg.value == '') {
        ...
        let createdElem = document.createElement('h2')
        createdElem.innerHTML = compileRegTemplate({regNumber: addElements.getReg()})
        regParent.appendChild(createdElem)
